  ...
  return (
    ...
    >
      ...
      <div className="mt-4 border-t border-[rgba(124,58,237,0.08)] pt-4 flex gap-3">
        ...
        <a className="w-10 h-10 rounded-full flex items-center justify-center bg-[rgba(90,89,185,0.12)] hover:bg-[rgba(90,89,185,0.2)] transition-colors" href={user.socials.email} title="Email">
          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
